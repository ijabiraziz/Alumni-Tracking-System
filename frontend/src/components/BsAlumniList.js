...
import {listAllAlumnis, listBsAlumnis} from '../actions/AlumniActions'
...
export default function BsAlumni({header}) {
  ...
  const bs_alumnis_s = useSelector (state => state.listBsAlumnis)
  const {error, loading, bs_alumni} = bs_alumnis_s

  useEffect (()=>{
    dispatch(listBsAlumnis());
  }, [])
